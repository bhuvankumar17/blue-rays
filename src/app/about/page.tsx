...
export const metadata: Metadata = {
  ...
  description: "Learn about Tamil Nadu's most trusted solar company. Expert installations across Chennai, Coimbatore, Madurai. ISO certified. Expert team. 30-year warranty. Government subsidy support.",
